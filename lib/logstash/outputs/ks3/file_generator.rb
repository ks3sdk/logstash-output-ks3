...
require 'uuid'
require 'logstash/outputs/ks3/gzip_file'
require 'logstash/outputs/ks3/temporary_file'
    ...
    class Ks3
      class FileGenerator
        ...
        def initialize(prefix, encoding, temporary_directory)
          ...
          # gzip or plain
          @encoding = encoding
          # temporary directory to save temporary file before upload to ks3
        ...
        def create_file
          ...
          file_name = "ls.ks3.#{uuid}.#{Time.now.strftime(STRFTIME)}.part-#{index}.#{extension}"
