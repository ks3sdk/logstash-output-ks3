Gem::Specification.new do |s|
  s.name          = 'logstash-output-ks3'
  s.version       = '0.0.1'
  s.licenses      = ['Apache-2.0']
  s.summary       = 'Sends Logstash events to the Ksyun Object Storage Service'
  ...
  s.requirements << "jar 'com.ksyun:ks3-kss-java-sdk', '1.0.2'"
end
